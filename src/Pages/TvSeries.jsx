...
//           {data.map((series) => (
//             <div key={series.id} className="bg-gray-800 p-2 rounded shadow-md hover:transform hover:scale-x-105 transition-transform duration-200 cursor-pointer">
//               <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ">
          {data.map((series) => (
            <Link to={`/tv/${series.id}`} key={series.id}> 
              <div className="bg-gray-800 p-2 rounded shadow-md hover:transform hover:scale-105 transition-transform duration-200 cursor-pointer">
                <img
                  src={`${IMAGE_BASE_URL}${POSTER_SIZE}${series.poster_path}`}
                  alt={series.name}
                  className="w-full rounded"
                ...
                <p className="text-gray-300 text-xs">First Air Date: {series.first_air_date}</p>
